...
describe Cybersourcery::CybersourceSigner do
      ...
      'pwksgem' =>
        {
          ...
          'locale' => 'en-us',
          'currency' => 'USD',
          'unsigned_field_names' => %w(bill_to_email bill_to_forename bill_to_surname bill_to_address_line1 bill_to_address_line2 bill_to_address_country bill_to_address_state bill_to_address_postal_code bill_to_address_city card_cvn card_expiry_date card_number card_type)
        }
    }
  ...
  describe '.signature_message' do
    ...
    subject { Cybersourcery::CybersourceSigner.signature_message(form_fields, %i[biz foo]) }
...
describe Cybersourcery::CybersourceSigner::Signer do
  describe '.signature' do
    let(:signature) { Cybersourcery::CybersourceSigner::Signer.signature(data, secret_key) }
